...
export default function Home() {
    ...
    return (
        <div className="w-full h-full p-8 grid grid-cols-4 grid-rows-2 gap-4">
            { session ? (
                <button onClick={() => router.push("/projects/1")} className="rounded-lg bg-orange-50 shadow-lg ease-out transition scale-100 hover:scale-105 hover:ease-in hover:border-2 border-orange-400">
